...
//        if (self.ischrome) return 'url(http://mail.google.com/mail/images/2/openhand.cur)';  // same as gmail for chrome cursor bug
        if (self.ischrome||(self.isie&&!self.isie9)) {  // force setting for some old IE return false positive and chrome cursor bug
